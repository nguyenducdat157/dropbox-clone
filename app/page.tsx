  ...
  return (
    <main className=''>
      <div className="flex flex-col lg:flex-row items-center bg-[#1E1919] dark:bg-slate-800">
        <div className="p-10 flex flex-col bg-[#2B2929] dark:bg-slate-800 text-white space-y-5">  
          <h1 className="text-5xl font-bold">
            ...
            <br />
            Storing everything for you and yoyr business needs. All in one place
          </h1>

          <p className="pb-20">
            Enhance your personal storage with Dropbox, offering a simple
            and 
            efficient way to upload, organizw, and access files from
            anywhere.
      ...
      <p className="text-center font-light p-2">
        ...
        only. We do not own or afffiliate with Dropbox or/and any
        of its subsidiaries in any form.
